$(document).ready(function(){
  ...
  var aboutElements = (function(){
    ...
    aboutLeftWidth = $('.about-left').innerWidth(),
    aboutRight = $('#bio .about-right'),
    aboutRightWidth = $('.about-right').css({'display':'inline','width':'auto'}).innerWidth(),
    aboutOne = $('#about-one'),
    aboutFourImg = $('#about-four img');
    $('.about-left, .about-right').css({'width':0, 'right': 0, 'left': 0, 'margin': 'auto'});
    return {
      body: body,
  ...
  var scrollMagicData = (function(){
      ...
      tween1 = {width: aboutElements.aboutLeftWidth, force3D: true},
      tween2 = {rotation: -360, force3D: true},
      tween4 = {width: aboutElements.aboutRightWidth, force3D: true},
  ...
  (function() {
    if($(window).width() > 700) {
      ...
      scrollMagicData.tween4.right = aboutRightHalfWidth;
  ...
  .on('start', function(e) {
    if(e.scrollDirection === 'FORWARD'){
      ...
      aboutElements.body.css({'background-color':'#FFD23F'});
    }
    else {
      if($('.fa-arrow-down').length > 0) {
        $('.fa-arrow-down').show();
      }
      aboutElements.body.css({'background-color':'#FFF'});
    }
  }).addTo(scrollMagicData.controller);
  ...
  .on('start', function(e){
    if(e.scrollDirection === 'FORWARD'){
      aboutElements.aboutLeft.fadeIn();
    }
    else {
      aboutElements.aboutLeft.fadeOut();
    }
  }).addTo(scrollMagicData.controller);
  ...
  .on('start', function(e) {
    if(e.scrollDirection === 'FORWARD'){
      aboutElements.body.css({'background-color':'#0EB1D2'});
    }
    else {
      aboutElements.body.css({'background-color':'#FFD23F'});
    }
  ...
  .on('start', function(e) {
    ...
    {
      aboutElements.aboutLeft.fadeOut();
      aboutElements.profileImg.attr('src','images/www.svg').css('border','none');
    }
  }).addTo(scrollMagicData.controller);
  ...
  .on('start', function(e) {
    if(e.scrollDirection === 'FORWARD'){
      aboutElements.aboutRight.fadeIn();
    }
    else {
      aboutElements.profileImg.attr('src','images/stacy_bw.jpg').css('border','3px solid #000');
      aboutElements.aboutRight.fadeOut();
      aboutElements.aboutLeft.fadeIn();
    }
  }).addTo(scrollMagicData.controller);
  ...
  .on('start', function(e) {
    if(e.scrollDirection === 'FORWARD'){
      aboutElements.body.css({'background-color':'#82D173'});
    }
    else {
      aboutElements.body.css({'background-color':'#0EB1D2'});
    }
  ...
  .on('start', function(e) {
    if(e.scrollDirection === 'FORWARD'){
      setTimeout(function(){
        aboutElements.aboutFourImg.css({'opacity':'1'});
      }, 500);
    }
    else {
      aboutElements.aboutFourImg.css({'opacity':'0'});
    }
  }).addTo(scrollMagicData.controller);
  ...
  .on('start', function(e) {
    if(e.scrollDirection === 'FORWARD'){
      $('.fa-github').addClass('slide-down-in');
    }
    else {
      $('.fa-github').removeClass('slide-down-in');
    }
  })
