$(document).ready(function(){
  ...
  if(document.getElementById('about-one')) {
    ...
    .on('start', function(e) {
      if(e.scrollDirection === 'FORWARD'){
        ...
        aboutElements.aboutOne.css({'background-image':'none'});
      }
    });
    ...
    .on('start', function(e){
      if(e.scrollDirection === 'FORWARD'){
        aboutElements.aboutLeft.hide().html('My name is Stacy').fadeIn();
      }
      else {
    ...
    .on('start', function(e) {
      if(e.scrollDirection === 'FORWARD'){
        aboutElements.aboutRight.hide().html('I develop websites').fadeIn();
      }
      else {
    ...
    $.each(scrollMagicData.scenes, function(_, scene){
      scene.addTo(scrollMagicData.controller);
    });
  }
});
