<div class="container">
  ...
  <div class="row" style="margin-top:2rem;">
    <div class="col-lg-10 col-md-12 slide-down-in" style="margin: auto;">
      ...
      <h3>SKILLS</h3>
      <p>JavaScript, ES6, AngularJS, Service Workers, IndexDB, jQuery, Responsive Design, Mobile Development, Flexbox, Bootstrap, SASS, Node.js, Gulp.js, Puppeteer.js, PHP, Java, ColdFusion, MySQL, MongoDB, Drupal, Git, Github, SVN</p>
    </div>
  </div>
</div>
